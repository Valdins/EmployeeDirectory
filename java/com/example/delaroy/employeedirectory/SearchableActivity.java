...
import com.example.delaroy.employeedirectory.data.EmployeeProvider;
...
public class SearchableActivity extends ListActivity {
    ...
    private void fillList(String query) {
        ...
        Cursor cursor = getContentResolver().query(
                ...
                null,
                EmployeeContract.EmployeeEntry.COLUMN_FIRSTNAME + " LIKE ? OR " + EmployeeContract.EmployeeEntry.COLUMN_LASTNAME + " LIKE ?",
